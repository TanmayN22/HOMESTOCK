...
class NotiService {
  ...
  Future<void> initNotification() async {
    ...
    tz.setLocalLocation(tz.getLocation('Asia/Kolkata')); // Change timezone if needed
  ...
  Future<void> scheduleNotification({
    ...
    print('✅ Scheduled notification "$title" will fire in $timeUntilNotification at $scheduledDate');
  }
